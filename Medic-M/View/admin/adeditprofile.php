...
<html lang="en">
  ...
  $gender="";
    ...
    $result1=querydb("SELECT * FROM SIGNUP_ADMIN WHERE USERNAME='".$_SESSION["uname"]."'");
...
?>
                ...
                <form action="../../Controller/admin/profileedit.php" method="post"><br>
