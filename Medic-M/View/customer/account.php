...
?>
          ...
          <tr>
            <td style="position: relative; left: 43%; color: #d63549; font-size: 24px ;">
              <br />
              <form action="../../Controller/customer/account.php" method="post">
          ...
          <tr>
            <td style="position: relative; left: 42%; color: #d63549; font-size: 24px ;">
              <br />
          ...
          <tr>
            <td style="position: relative; left: 85%; color: #d63549; font-size: 24px ;">
              <br><br><a href="customer_profile.php"><input type="submit" value="Go Back" name="goback" class="button"></a>
              <br><br><br>
            </td>
          </tr>
        </table>
