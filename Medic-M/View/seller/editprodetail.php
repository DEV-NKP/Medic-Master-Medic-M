...
?>
            ...
            <td colspan="2" align="center"><h1 style="color: #dfc1c3;">Modify Product</h1><hr></td>
...
<tr>
    ...
    &nbsp;&nbsp; &nbsp;&nbsp; <font size="3px" color="white"> Product's Name&nbsp;&nbsp;&nbsp;&nbsp;:</font> &nbsp;&nbsp;&nbsp;<input style="background-color: rgba(255, 255, 255, 0.178); color:rgb(238, 227, 227) ;border:0px;padding: 5px; border-radius: 8px;font-size: 16px;font-family: 'Times New Roman', Times, serif;" type="text" value="<?php echo $pname;?>" name="pname" required>
    </td>
<td style="text-align: left; padding-bottom: 50px;">
  ...
  <tr>
    ...
    &nbsp;&nbsp; &nbsp;&nbsp; <font size="3px" color="white"> Product's Price&nbsp;&nbsp;&nbsp;&nbsp;:</font> &nbsp;&nbsp;&nbsp;<input style="background-color: rgba(255, 255, 255, 0.178); color:rgb(238, 227, 227) ;border:0px;padding: 5px; border-radius: 8px;font-size: 16px;font-family: 'Times New Roman', Times, serif;" type="number" value="<?php echo $pprice;?>" name="pprice" required>
    </td>
<td style="text-align: left; padding-bottom: 50px;">
    
    &nbsp;&nbsp; &nbsp;&nbsp; <font size="3px" color="white"> Product's Quantity&nbsp;&nbsp;&nbsp;&nbsp;:</font> &nbsp;&nbsp;&nbsp;<input style="background-color: rgba(255, 255, 255, 0.178); color:rgb(238, 227, 227) ;border:0px;padding: 5px; border-radius: 8px;font-size: 16px;font-family: 'Times New Roman', Times, serif;" type="number" value="<?php echo $pcount;?>" name="pcount" required>
    </td>
   ...
   <tr>
    ...
    &nbsp;&nbsp; &nbsp;&nbsp; <font size="3px" color="white"> Product's Company Name&nbsp;&nbsp;&nbsp;&nbsp;: </font>&nbsp;&nbsp;&nbsp;<input style="background-color: rgba(255, 255, 255, 0.178); color:rgb(238, 227, 227) ;border:0px;padding: 5px; border-radius: 8px;font-size: 16px;font-family: 'Times New Roman', Times, serif;" type="text" value="<?php echo $pcom;?>" name="pcom" required>
    </td>
<td style="text-align: left; padding-bottom: 50px;">
    
    &nbsp;&nbsp; &nbsp;&nbsp; <font size="3px" color="white"> Product's Weight &nbsp;&nbsp;&nbsp;&nbsp;:</font> &nbsp;&nbsp;&nbsp;<input style="background-color: rgba(255, 255, 255, 0.178); color:rgb(238, 227, 227) ;border:0px;padding: 5px; border-radius: 8px;font-size: 16px;font-family: 'Times New Roman', Times, serif;" type="number" value="<?php echo $pweight;?>" name="pweight" required>
    </td>
   ...
   <tr> <td colspan="2" style="text-align: center; padding-bottom: 50px;">
    ...
    <font size="3px" color="white"> <b> Product's Description</b><br><br></font><textarea align="center" style="background-color: rgba(255, 255, 255, 0.178); color:rgb(238, 227, 227) ;border:0px;padding: 5px; border-radius: 8px;font-size: 16px;font-family: 'Times New Roman', Times, serif;" name="pdetail"  rows="3" cols="60" required><?php echo $pdetail;?></textarea>    
    </td>


</tr>
   <tr> <td style="text-align: center; padding-bottom: 50px;">
<a href="editproduct.php"  style="text-decoration:none;" class="button">Go Back</a>
    </td>
    
    <td style="text-align: center; padding-bottom: 50px;">
    <input type="submit" value="Save Changes" name="editproductsub" class="button"><br><br><br>
