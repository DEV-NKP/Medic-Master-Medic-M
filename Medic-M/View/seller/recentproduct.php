...
<html lang="en">
  ...
  <body style="background-color: #22212e;">
    ...
    align="center"
      ...
      <section>
<h1 align="center"style="color: #dfc1c3;"><font style="font-size: 35px;">Recent Products </font> <br><br>
<a href="yourproduct.php"align="left" style="text-decoration: none; padding-top:10px ; padding-bottom: 10px; padding-left: 20px; padding-right: 20px; border-radius: 10px; border-width: 0; background-color: #dfc1c3; font-size: 18px; color: #22212e;">Go Back</a>
<br><br><hr></h1>
       </section>
<?php
...
$result1=querydb("SELECT * FROM PRODUCT WHERE PRODUCT_SELLER='".$_SESSION["uname"]."'");
  ...
  if($result1->num_rows>0)
  {
     ...
     while($var = mysqli_fetch_assoc($result1))
     {
      ...
      <hr><font style="font-size: 20px; font-weight: bold;">Modification Time: </font><font style="font-size: 18px;">'.$var["PRODUCT_POST_TIME"].'</font><br>    
      <br>   
      </section>
      <br><br><br>');
...
<hr><font style="font-size: 20px; font-weight: bold;">Modification Time: </font><font style="font-size: 18px;">'.$var["ptime"].'</font><br>    
<br>   
</section>
<br><br><br>');
