...
<html lang="en">
  ...
  <body style="background-color: #22212e;">
    ...
    align="center"
      ...
      <section>
<h1 align="center"style="color: #dfc1c3;"><font style="font-size: 35px;">Remove Products </font> <br><br>
...
$result1=querydb("SELECT * FROM PRODUCT WHERE PRODUCT_SELLER='".$_SESSION["uname"]."'");
  ...
  if($result1->num_rows>0)
  {
     ...
     {
      echo('
      <section style="background-color: rgba(221, 190, 187, 0.924);   border-radius: 25px;" align="center">
      <br><br>
      <img
      ...
      <a href="removeprodetail.php?id='.$var["PRODUCT_ID"].'"align="left" style="margin-left: 400px; text-decoration: none; padding-top:5px ; padding-bottom: 5px; padding-left: 20px; padding-right: 20px; border-radius: 10px; border-width: 0; background-color: #be6767b9; font-size: 18px; color: #22212e;">Remove</a>
      <br> <br> 
      </section>
      <br><br><br>');
...
<a href="removeprodetail.php?id='.$var["pid"].'"align="left" style="margin-left: 400px; text-decoration: none; padding-top:5px ; padding-bottom: 5px; padding-left: 20px; padding-right: 20px; border-radius: 10px; border-width: 0; background-color: #be6767b9; font-size: 18px; color: #22212e;">Remove</a>
<br> <br> 
</section>
<br><br><br>');
