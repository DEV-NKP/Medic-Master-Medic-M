...
<html lang="en">
  ...
  <body style="background-color: #22212e">
    <div style="width: 50%">
      ...
      <section>
        <br>
<h1 align="center"style="color: #dfc1c3;"><font style="font-size: 35px;">Pending Delivery </font> <br>
<br><hr></h1>
       </section>
       <br>
...
$result1=querydb("SELECT * FROM ORDER_LIST WHERE SNAME='".$_SESSION["uname"]."'");
...
if($result1->num_rows>0)
{
   ...
   while($var = mysqli_fetch_assoc($result1))
   {
    ...
    $result111=querydb("SELECT * FROM signup_customer WHERE USERNAME='".$var["CNAME"]."'");
    $var2 = mysqli_fetch_assoc($result111);
    echo('
    ...
    <font style="font-size: 20px; font-weight: bold;">Total Price: </font><font style="font-size: 18px;">'.$var["TOTAL_PRICE"].'</font><br> 
    <font style="font-size: 20px; font-weight: bold;">Customer Address : </font><font style="font-size: 18px;">'.$var2["ADDRESS"].'</font><br> 

    <hr><font style="font-size: 20px; font-weight: bold;">Cart Add Time: </font><font style="font-size: 18px;">'.$var["UPDATE_TIME"].'</font>  

<a href="../../Model/seller/delivery.php?id='.$var["ORID"].'"align="left" style="margin-left: 400px; text-decoration: none; padding-top:5px ; padding-bottom: 5px; padding-left: 20px; padding-right: 20px; border-radius: 10px; border-width: 0; background-color: #be6767b9; font-size: 18px; color: #22212e;">Delivered</a>
<br><br>
  </section>
    <br><br><br>');
