    ...
    <div style="width: 50%">
      ...
      >
        <table style="width: 100%">
          <tr>
            <td align="center">
              <h1 style="color: #d63549">User's Profile</h1>
          ...
          <tr>
            <td
              ...
              "
            >
              <br /><br /><a href="account.php" style="margin-left: -15px"
                ><input
                  type="submit"
                  value="Medic-M Bank"
                  name="editprofile"
